package UILogic
{
	...
	public class Item_RoomTableInfo extends Component
	{
		...
		public function Item_RoomTableInfo()
		{
			super();
			...
			//m_tGamePlayerNum.y = 12;
			m_tGamePlayerNum.SetCenterPoint(new Point(m_ptArray[3].x+15,m_ptArray[3].y));
...
//			}
		...
		public function UpdateTableInfo(TI:Data_TableInfo):void
		{
			...
			if( GlobleData.s_MyPID>0 && TI.m_CreatePID==GlobleData.s_MyPID )
			{
				m_tTableName.SetTextColor(0xff0000);
			}
			else
			{
				m_tTableName.SetTextColor(0xffffff);
			}
		}
	}
}